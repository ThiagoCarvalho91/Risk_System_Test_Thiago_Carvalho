...
using Risk_System_Test_Thiago_Carvalho.Models;
    ...
    static void Main()
    {
        ...
        do
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                while (!validInput)
                {
                    Console.WriteLine($"Enter trade {i + 1} in the format: value sector date (e.g., Value(USD) Sector Date(format MM/dd/yyyy))");
                    ...
                    {
                        Console.WriteLine("Error: You must provide exactly three parameters: value, sector, and date.");
                        continue; 
                    }
                    else
                    {
                        ...
                        Console.WriteLine($"Received value: {tradeData[0]}, sector: {tradeData[1]}, date: {tradeData[2]}");
                        ...
                        ITrade trade = new Trade(value, sector, nextPaymentDate);
